...
st.write("Predictions are validated against the test simulation data")   
st.markdown("<hr/>", unsafe_allow_html=True)    
    
with st.expander("Validation Plots"):
...
st.markdown("Error in predicted data with respect to the test simulation data")
st.markdown("<hr/>", unsafe_allow_html=True)
